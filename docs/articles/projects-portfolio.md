...
Kokoro Pipeline is a full-featured automated development pipeline engine that orchestrates Claude Code agents through structured multi-phase software development workflows. It provides a React web console with a visual pipeline designer and a SaaS platform layer for multi-tenant deployment.

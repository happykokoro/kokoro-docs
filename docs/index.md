...
A 14-product technology portfolio spanning quantitative finance, blockchain, and AI — 530,000+ lines of production code, deployed across 3 cloud servers connected via self-built WireGuard mesh VPN. Built and operated by a single founder leveraging AI-augmented development workflows.
